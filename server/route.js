...
module.exports = function (app, db, passport) {
    ...
    app.post('/Umbrella/service/login', function (req, res) {
    ...
    app.post('/Umbrella/service/login-facebook', passport.authenticate('facebook-token', {session: false}),
        function (req, res) {
    ...
    app.get('/Umbrella/service/validate', jwtauth.auth, function (req, res) {
        console.log('umbrella :: service :: validate');
        return res.send(200, req.user);
    });

    app.post('/Umbrella/service/colors', jwtauth.auth, function(req,res){
...
//        });
    ...
    app.post('/Umbrella/service/findBarLocation', jwtauth.auth, function(req,res) {
    ...
    app.get('/Umbrella/service/resetPassword/:id', jwtauth.auth, function (req, res) {
    ...
    app.post('/Umbrella/service/changePassword', jwtauth.auth, function (req, res) {
    ...
    /******* UMBRELLA.BAR SERVICES ******/
        //get all bars
    app.get('/Umbrella/service/bars', jwtauth.auth, function (req, res) {
    ...
    //get one bar
    app.get('/Umbrella/service/bars/:id', jwtauth.auth, function (req, res) {
    ...
    //add a bar
    app.post('/Umbrella/service/bars', jwtauth.auth, function (req, res) {
    ...
    //delete a bar
    app.delete('/Umbrella/service/bars/:id', jwtauth.auth, function (req, res) {
    ...
    //update a bar
    app.put('/Umbrella/service/bars/:id', jwtauth.auth, function (req, res) {
    ...
    /******* UMBRELLA.CATEGORIES SERVICES ******/
        //get all categories
    app.get('/Umbrella/service/categories', jwtauth.auth, function (req, res) {
    ...
    //get one category
    app.get('/Umbrella/service/categories/:id', jwtauth.auth, function (req, res) {
    ...
    //add a category
    app.post('/Umbrella/service/categories', jwtauth.auth, function (req, res) {
    ...
    //delete a category
    app.delete('/Umbrella/service/categories/:id', jwtauth.auth, function (req, res) {
    ...
    //update a category
    app.put('/Umbrella/service/categories/:id', jwtauth.auth, function (req, res) {
    ...
    /******* UMBRELLA.USERS SERVICES ******/
        //get all users
    app.get('/Umbrella/service/users', jwtauth.auth, function (req, res) {
    ...
    //get one user
    app.get('/Umbrella/service/users/:id', jwtauth.auth, function (req, res) {
    ...
    //add a user
    app.post('/Umbrella/service/users', function (req, res) {
    ...
    //delete a user
    app.delete('/Umbrella/service/users/:id', jwtauth.auth, function (req, res) {
    ...
    //update a user
    app.put('/Umbrella/service/users/:id', jwtauth.auth, function (req, res) {
    ...
    /******* UMBRELLA.CHECKINS SERVICES ******/
        //get all checkins
    app.get('/Umbrella/service/checkins', jwtauth.auth, function (req, res) {
    ...
    //get one checkin
    app.get('/Umbrella/service/checkins/:id', jwtauth.auth, function (req, res) {
    ...
    //add a checkin
    app.post('/Umbrella/service/checkins', jwtauth.auth, function (req, res) {
    ...
    //delete a checkin
    app.delete('/Umbrella/service/checkins/:id', jwtauth.auth, function (req, res) {
    ...
    //update a checkin
    app.put('/Umbrella/service/checkins/:id', jwtauth.auth, function (req, res) {
...
//bcrypt.hashSync(password, bcrypt.genSaltSync(8), null);
    ...
    app.get('/Umbrella', function (req, res) {
        res.sendfile('./Umbrella/app/index.html');
    });
}